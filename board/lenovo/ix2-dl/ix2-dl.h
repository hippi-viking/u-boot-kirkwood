...
#define IX2-DL_OE_LOW		(~(HDD2_GREEN_LED | HDD2_RED_LED | \
				   USB_GREEN_LED | USB_POWER | \
				   SYS_GREEN_LED | SYS_ORANGE_LED))
#define IX2-DL_VAL_LOW		(SYS_GREEN_LED | USB_POWER)
...
#define IX2-DL_OE_HIGH		(~(COPY_GREEN_LED | COPY_RED_LED | \
				   HDD1_GREEN_LED | HDD1_RED_LED | HDD2_POWER | WATCHDOG_SIGNAL ))
#define IX2-DL_VAL_HIGH		(WATCHDOG_SIGNAL | HDD2_POWER)
